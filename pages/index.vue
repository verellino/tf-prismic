    ...
    <div class="container">
      ...
      >
        ...
        <div class="w-1/2 flex justify-center align-center">
          <img src="@/assets/images/Hero-img.png" alt="Transforming Futures" class="h-auto max-h-20 w-full" />
        </div>
      </div>
    </div>
              ...
              <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-3">
                  ...
                  <input
                    ...
                    class="mt-1 h-12 px-4 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-2 border-gray-400 rounded-md"
                  />
                </div>
                ...
                <div class="col-span-6">
                  ...
                  <input
                    ...
                    id="lorem"
                    autocomplete="lorem"
                    class="mt-1 h-72 px-4 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-2 border-gray-400 rounded-md"
                  />
                </div>
              </div>
            </div>
